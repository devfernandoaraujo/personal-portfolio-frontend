...
const BannerComponent = () => {
  ...
  return (
    <section itemScope itemType="http://schema.org/WPHeader" className={degrade ? 'frelencer_banner_area frelencer_banner_area-degrade' : 'frelencer_banner_area'} id="home">
      <div itemScope itemType="http://schema.org/CreativeWork" className={'home_bubble'}>
      ...
      <Image itemProp="image" className={styles.banner + ' react-reveal fadeInRight s_shap'} src="/images/banner_img.d852f421.svg" width="0" height="0" alt="banner" />
          ...
          <div className={'col-lg-6'}>
            <div className={'frelencer_img'}>
              ...
              <Image itemProp="image"
                ...
                height={69}
              />
              <Image itemProp="image" className="react-reveal fadeInDown f_img_four imageFour" src="/images/shadow1add9ee7.webp" alt="shadow1add9ee7" width={412} height={267} />
              <div className={'react-reveal fadeInDown f_img_five ' + styles.imageFive}>
                <Image  itemProp="image"className="" src={`data:image/webp;base64,${binaryImages.bannerImages.imageFive}`} alt="imageFive" width={56} height={83} />
              </div>
              <div className={'f_img_six'}>
                <Image itemProp="image" className="" src={`data:image/webp;base64,${binaryImages.bannerImages.imageSix}`} alt="imageSix" width={56} height={83} />
              </div>
              <div className={'f_img_seven'}>
                <Image itemProp="image" className="" src={`data:image/webp;base64,${binaryImages.bannerImages.imageSeven}`} alt="img_seven" width={56} height={83} />
              </div>
              <div className={'f_img_eight'}>
                <Image itemProp="image" className="" src={`data:image/webp;base64,${binaryImages.bannerImages.imageEight}`} alt="img_eight" width={56} height={83} />
              </div>
              <div className={'f_img_nine'}>
                <Image itemProp="image" className="" src={`data:image/webp;base64, ${binaryImages.bannerImages.imageNine}`} alt="img_nine" width={56} height={83} />
              </div>
            </div>
          </div>
        </div>
