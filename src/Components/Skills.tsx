        ...
        <div className={'row align-items-center'}>
          <div className={'col-lg-6'}>
            <div className={'skill_content_two'}>
              ...
              <p>
                I realized that running is a part of my life. Through running I
                discovered that I can be able to improve my skills on any
                subject I what to learn or do.{' '}
              </p>
              <div className={'section_title_two undefined'}>
              ...
              <Slider {...settings}>
                {carouselImages.map((image) => (
                  <div className={'carousel-item text-center'}>
                    <img
                      src={image.src}
                      className={'d-block rounded mx-auto w-50 h-50'}
                      alt="..."
                    />
                    <h6>{image.name}</h6>
                  </div>
          ...
          <div className={'col-lg-6'}>
            <img
              className={'fact_img'}
              src={process.env.PUBLIC_URL + '/images/mobile.d871640b.svg'}
              alt=""
            />
          </div>
        </div>
