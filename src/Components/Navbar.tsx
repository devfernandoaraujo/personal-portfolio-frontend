  ...
  return (
    <div className={'sticky-outer-wrapper fixed-top'}>
      <div
        ...
        style={NavbarComponentStyles.innerWrapper}
      >
        <nav
          className={
            fix
              ? 'navbar navFixed navbar-expand-lg navbar-light menu_two'
              : 'navbar  navbar-expand-lg navbar-light menu_two'
          }
        >
          <div className={'container'}>
            <a
              href="https://fernandomatosaraujo.com"
